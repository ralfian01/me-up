...
abstract class DBConnection implements DBConnectionInterface
{
    ...
    /**
     * Strict ON flag Whether we're running in strict SQL mode. 
     * @var bool
     */
    protected $strictOn;
    ...
    /**
     * List of reserved identifiers Identifiers that must NOT be escaped. 
     * @var array
     */
     ...
     * @return bool;
     */
    abstract protected function _transBegin();

    /**
     * Commit Transaction
     * @return bool
     */
    abstract protected function _transCommit();

    /**
     * Rollback Transaction
     * @return bool
     */
    abstract protected function _transRollback();
     ...
     * @return string
     */
    private function protectDotItem(string $item, string $alias, bool $protectIdentifiers, bool $fieldExists)
    {
        $parts = explode('.', $item);
     ...
     * @return string
     */
    protected function _escapeString(string $str)
    {
     ...
     * @return string
     */
    protected function getDriverFunctionPrefix()
    {
     ...
     * @return array;
     */
    abstract protected function _fieldData(string $table);

    /**
     * @return array;
     */
    abstract protected function _indexData(string $table);

    /**
     * @return array;
     */
    abstract protected function _foreignKeyData(string $table);
